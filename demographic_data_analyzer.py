...
def calculate_demographic_data(print_data=True):
    ...
    rich_percentage =(num_min_workers/total_min_workers.shape[0])*100
    ...
    earn_50K_India = df[ (df['salary']== '>50K')& (df['native-country']== 'India') ]
    top_IN_occupation = earn_50K_India['occupation'].value_counts().idxmax()
